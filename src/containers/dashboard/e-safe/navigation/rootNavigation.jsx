...
import { listUnderParent } from "../../../../services/e-safe";
...
function rootNavigation() {
  ...
  const {
    ...
    [listUnderParent, currentPage],
    () => listUnderParent(location.state.edmStor, currentPage, ItemsPerPage)
  );
  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.table}>
        <Tree
          items={[
            { name: "root", onClick: () => { push("/dashboard/e-safe/navigation/root"); } },
            { name: "folder-1", onClick: () => { push("/dashboard/e-safe"); } },
            { name: "folder-2", onClick: () => folderNavigate("clicked") }
          ]}
        />
